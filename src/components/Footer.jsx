  ...
  return (
    ...
    <footer className="bg-slate-950 border-t border-slate-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20">
        ...
        <div className="grid grid-cols-4 md:grid-cols-2 lg:grid-cols-4 gap-14">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-slate-800 hover:bg-green-500 transition flex items-center justify-center"
              >
                <FaWhatsapp />
              </a>
